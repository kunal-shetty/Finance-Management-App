...
const STEPS = [
  ...
  { id: "name", component: OnboardingName },
...
export function OnboardingFlow({ onComplete }: OnboardingFlowProps) {
  ...
  const canProceed = currentStep !== 3 || fullName.trim().length > 0 // Name step requires input
    ...
    <div className="fixed inset-0 z-40 flex flex-col bg-background safe-top safe-bottom">
      ...
      <div className="flex justify-end p-4">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => fullName.trim() ? onComplete(fullName.trim()) : null}
      ...
      <div className="flex-1 overflow-hidden px-6">
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            {currentStep === 3 ? (
              <CurrentStepComponent onNameChange={setFullName} initialName={fullName} />
            ) : (
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          ...
          <Button size="lg" onClick={goNext} className="flex-1" disabled={!canProceed}>
